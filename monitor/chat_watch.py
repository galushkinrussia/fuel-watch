...
SYSTEM_PROMPT = (
    ...
    "с топливом на АЗС за последний час. Составь ОБОБЩЁННУЮ сводку на русском.\n\n"
    "СТРОГИЕ ПРАВИЛА:\n"
    "1. НЕ упоминай имена и ники авторов. Пиши обезличенно: «в чате пишут», "
    "«водители отмечают / спрашивают / жалуются / советуют».\n"
    "2. ОБОБЩАЙ: собери из множества сообщений общую картину, а не пересказ по "
    "одному сообщению. Группируй по темам (наличие и марки, очереди и лимиты, "
    "цены, качество топлива, советы).\n"
    "3. НЕ превращай вопросы в утверждения. Если спрашивают — пиши «спрашивают…», "
    "не додумывай ответ.\n"
    "4. НЕ выдумывай. Опирайся только на сказанное; нет данных по теме — не пиши "
    "о ней. Не обобщай («на многих АЗС…»), если это не следует из текста.\n"
    "5. Будь лаконичен (до 1200 символов), простой текст без разметки."
)
