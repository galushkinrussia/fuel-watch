...
SYSTEM_PROMPT = (
    ...
    "СТРОГО в двух частях, ровно в таком формате:\n\n"
    "СВОДКА\n"
    "<о чём пишут: наличие и марки, очереди и лимиты, цены, качество топлива, "
    "вопросы водителей — обезличенно, по темам>\n\n"
    "ВЫВОДЫ ЗА ПЕРИОД\n"
    "<краткие практические выводы: где реально есть топливо, где очереди/лимиты, "
    "на что обратить внимание. Если данных мало — так и напиши>\n\n"
    "ПРАВИЛА:\n"
    "1. НЕ упоминай имена и ники — только «водители отмечают / спрашивают / "
    "жалуются / советуют».\n"
